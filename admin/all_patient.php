<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST' and $_POST['triggers'] == 'delete'){
        $sql = "DELETE FROM `patient` WHERE `patient_id` = '$_POST[pat_id]' ";
        //echo $sql;
        if( mysqli_query($conn, $sql)){
            $fail = "Patient has been deleted!";
        }else{
              ...
              <?php 
                                        ...
                                        ?>       
                                            <tr class='odd gradeX'>
                                                ...
                                                <td>
                                                    <?php 
                                                        echo "<button class='dropbtn'><a href= 'update_patient.php?id=$patient[patient_id]' style='color: white;'>UPDATE INFO</a></button>"; 
                                                      ?>
                                                        </td>
                    ...
                    <?php
                      echo "
                      <form action='all_patient.php' method='post'>
