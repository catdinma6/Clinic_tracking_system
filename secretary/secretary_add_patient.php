...
if($_SERVER['REQUEST_METHOD'] == 'POST' and $_POST['triggers'] == 'ADD'){
    ...
    $id = 'p-'.rand(100,999).'-'.rand(100,999);
    $err = 0;     
    ...
    if($err == 0){
        ...
        if($result = mysqli_query($conn, $sql)){
            if(mysqli_num_rows($result)==0){
                $sql = "INSERT INTO `patient` (`patient_id`,`addedby`, `name`, `email`,`dob`,`gender`, `phone`, `address`,`medical_history`) VALUES ('$id','$_POST[pat_name]','$userinfo->email','$_POST[pat_email]','$_POST[pat_dob]','$_POST[pat_gender]','$_POST[pat_phone]','$_POST[pat_add]','$_POST[comment]')";
