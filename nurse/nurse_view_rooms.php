              ...
              <?php 
                                        ...
                                        ?>       
                                            <tr class='odd gradeX'>
                                                ...
                                                <td class="center">
                                                    <?php 
                                                        echo "<button class='dropbtn'><a href= 'nurse_update_room.php?id=$room[room_id]' style='color: white;'>UPDATE INFO</a></button>"; 
                                                        echo "<button class='dropbtn'><a href= 'nurse_view_each_rooms.php?id=$room[room_id]' style='color: white;'>VIEW ROOM</a></button>";
