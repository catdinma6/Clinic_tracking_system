<?php
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST' and $_POST['triggers'] == 'ADD'){
                        ...
                        $sql = "INSERT INTO `appointment` (`doctor_id`,`patient_id`, `report`, `app_date`, `next_app_date`) VALUES ('$_POST[doctor]','$_POST[patient]','$_POST[report]','$_POST[app_date]','$_POST[next_app_date]')";
