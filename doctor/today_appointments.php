<?php
    ...
    $sql = "SELECT * FROM `appointment` WHERE DATE(app_date) = CURDATE() AND  `doctor_id` = '$userinfo->doctor_id'  ORDER BY `app_date` ASC ";
...
<link href="https://fonts.googleapis.com/css2?family=RocknRoll+One&display=swap" rel="stylesheet">
    ...
    <body>
        ...
        <p>DOCTOR | TODAY APPOINTMENTS </p>   
          ...
          <hr style="color: grey;">
          <br>
          <h3 style="text-align: center;">TODAY APPOINTMENTS </h3>
          <br>
          <hr style="color: grey;">
          <div class="table">
            <table>
