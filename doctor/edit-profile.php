...
<?php 
  require_once "../base.php";
    ...
    $id = (!empty($userinfo->doctor_id)) ? $userinfo->doctor_id : '';
    if(!empty($id)){
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST' and $_POST['what'] == 'Update'){
            $sql = "UPDATE `doctor` SET `name` = '$_POST[d_name]', `phone` = '$_POST[d_phone]', `address` = '$_POST[d_address]' WHERE `email` = '$_POST[d_email]' ";
...
<link href="https://fonts.googleapis.com/css2?family=RocknRoll+One&display=swap" rel="stylesheet">
    ...
    <body>
        ...
        <p>DOCTOR | UPDATE DOCTOR RECORD</p>
